  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel value={value} index={0}>
        ...
        The Graduate Record Examination (GRE) is a widely accepted entrance exam
        conducted for the purpose of admission in several courses offered at
        various foreign universities. The objective of GRE test is to evaluate
        the verbal, mathematical and also analytical skills of the students and
        to check whether they are eligible to apply for various courses.
        <br />
        GRE helps the admission committee in the universities to gauge students
        applying from across the world on the same platform, the exams are of
        same for all the students taking GRE across the world. Also, GRE scores
        are used by admissions or fellowship panels to supplement your
        undergraduate records, recommendation letters and other qualifications
        for graduate-level study. GRE is mandatory for most students aspiring
        for a Master Degree (except Business, Law and Medicine) and PhD courses
        in several universities in the US. The GRE revised test is accepted at
        thousands of graduate and business schools as well as departments and
        divisions within three schools.
      </TabPanel>
      ...
      <TabPanel value={value} index={2}>
        <div className='syllabus'>
          ...
          <br />
          <h3>3-ANALYTICAL WRITING ASSESSMENT (AWA)</h3>
          <p>
            <ul>
              <li>
